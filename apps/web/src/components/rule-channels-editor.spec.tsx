...
import type { NotificationChannelDto, RuleListItem, VocabulariesResponse } from "@bms/shared";
 ...
 */
function renderEditor(): { invalidateQueries: ReturnType<typeof vi.fn> } {
  ...
  render(
    <QueryClientProvider client={queryClient}>
      <RuleChannelsEditor ruleId={RULE_ID} />
    </QueryClientProvider>,
  );
