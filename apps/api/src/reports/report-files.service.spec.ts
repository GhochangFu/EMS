...
export const BODY: SaveEnergyReportFileBody = { startDate: "2026-09-01", endDate: "2026-09-07", format: "pdf", organizationId: ORG_ID };
...
export function save(h: Harness, body: SaveEnergyReportFileBody = BODY) {
  return h.service.saveOnDemand(JWT, body);
}

export async function saveRejecting(scenario: Scenario, body: SaveEnergyReportFileBody = BODY) {
