...
> `F4.45`; six codes since `E5.2` seeded `mechanical` through
> `asset-domains-seed.ts` rather than a migration, **ADR 0053**), and the alarm **severity** ladder following them into
...
> `HVAC_CLASS_POINT_KEYS` pair and `bms.point_keys` at 398 —
