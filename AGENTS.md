...
> rule for both exports (**ADR 0026** and its Amendment 1), the staleness gate in front of every
...
│   │                            src/vocabularies/ serves AND enforces the THREE
│   │                            open vocabularies — rule concerns and plant
│   │                            domains (ADR 0031 A1), and alarm severities
│   │                            (ADR 0032). Its service is not a convenience:
