...
- **ADR 0016 §6 commits 3 and 4 stay human-gated.** Commit 3 was the parallel
  ...
  having been accepted. **The repository owner instructed both on 2026-08-06**
  and they are done — that is the gate being satisfied, not removed, and it does
  not generalise to commit 4. Commit 4 deletes `src/index.js` and the
  `INGEST_NOTIFY` flag and **has no named owner** (ADR 0016 Resolved decision 4),
  which is a human decision by construction. Do not do it unprompted
