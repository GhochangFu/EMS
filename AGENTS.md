...
**three** gates, not the single source scan this paragraph names. `health` and
`optimisation` are unchanged in both halves and remain the two closed sections.
