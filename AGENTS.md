...
> is the write path, authorised by the row's scope. The window functions and
> `locations.timezone` are `E4.1b`'s; the stock sustainability points and the
